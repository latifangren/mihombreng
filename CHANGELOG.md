...
- **Flexible Auto-Restart Settings**: Expanded the Mihomo core auto-restart configurations with granular triggers for unexpectedly stopped processes (watchdog watchdog), configuration document updates, network interface adjustments, and scheduled time-based operations (hourly/daily).
